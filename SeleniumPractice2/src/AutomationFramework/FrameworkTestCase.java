...
public class FrameworkTestCase {
	...
	public void test() throws InterruptedException {
		...
		//Here I used method to write and make codes efficient
		searchPage.clickFlightTab();
		System.out.println("1");
		searchPage.clickMultiCity();
		System.out.println("1");
		searchPage.sendFlyFrom("New York");
		System.out.println("1");
		searchPage.sendflyTo("LA");
		System.out.println("1");
		searchPage.sendDepartDate("01/31/2018");
		System.out.println("1");
		searchPage.sendReturnDate(); //check the factory file
		
		
		
		
		//This is the general redundant old test case
